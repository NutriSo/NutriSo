          ...
          <div className="basicInfo-ContainerSocioData">
            <div className="entradasSocioData">
              <Form.Item label="Ocupación" name="ocupacion">
                ...
                >
                  {mocks.socioeconomico.ocupacion.map(({ label, value }) => (
                    <Option value={value}>{label}</Option>
                  ))}
                </Select>
              </Form.Item>
          ...
          <div className="basicInfo-ContainerSocioData">
            <div className="entradasSocioData">
              <Form.Item label="Modalidad" name="modalidad">
                ...
                >
                  {mocks.socioeconomico.modalidad.map(({ label, value }) => (
                    <Option value={value}>{label}</Option>
                  ))}
                </Select>
              </Form.Item>
            ...
            <div className="entradasSocioData">
              <Form.Item label="Horario de entrada" name="horarioEntrada">
                <input
                  ...
                  type="text"
                  name="horarioEntrada"
                  onChange={(event) => setHorarioEntrada(event.target.value)}
                />
              </Form.Item>
            </div>
            <div className="entradasSocioData">
            ...
            <div className="entradasSocioData">
              ...
              >
                <Select
                  ...
                  value={dineroDeAXMI}
                  onChange={(value) => setDineroDeAlimentacionXMesInd(value)}
                >
            ...
            <div className="entradasSocioData">
              ...
              >
                <Select
                  ...
                  value={dineroDeAXMH}
                  onChange={(value) => setDineroDeAlimentacionXMesHog(value)}
                >
