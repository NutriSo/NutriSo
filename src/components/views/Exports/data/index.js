export const opciones = [
    ...
    { id: 1, titulo: 'Datos demográficos (información básica lista)' },
    { id: 2, titulo: 'Grupos' },
    ...
    { id: 9, titulo: 'Registro día anterior' },
];
...
export const aspectosMedioambientales = [
    {
...
export const aspectosEconomicos = [
    {
        title: 'Precio',
        dataIndex: 'precio',
        key: 'precio',
...
export const componentesBioactivos = [
    {
        title: 'Fitoquímicos',
...
export const aditivosAlimentarios = [
    {
